...
public:
	...
	void DrawRegularPolygon(float x, float y, int nSides, float radius, Color c, float rotation = 0.0f);
	...
	void FillTriangleGradient(const Tesla::Vec2& v0, const Tesla::Vec2& v1, const Tesla::Vec2& v2, Color c0, Color c1, Color c2);
	void FillTriangleGradient(const Tesla::Vec2& v0, Color c0, const Tesla::Vec2& v1, Color c1, const Tesla::Vec2& v2, Color c2);
